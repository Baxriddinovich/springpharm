            ...
            if ($userId === $user['id']) {
                ...
                if ($targetUser && $targetUser['role'] === 'super_admin' && $user['role'] !== 'super_admin') {
                    ...
                    try {
                        ...
                        // ⭐ Bog'liq ma'lumotlarni tozalash (agar cascade yo'q bo'lsa)
            ...
            <div class="p-6 h-full flex flex-col">
                ...
                <nav class="space-y-1 flex-1 overflow-y-auto">
                    ...
                    <div class="pt-4 mt-4 border-t border-slate-700/50">
                        ...
                        <a href="users.php" class="nav-item active flex items-center gap-3 px-4 py-3 rounded-lg text-white" aria-current="page">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <tr class="user-row <?php echo $isMe ? 'bg-cyan-500/5' : ''; ?>">
                                        ...
                                        <td class="px-6 py-4 text-center hidden sm:table-cell">
                                            <div class="text-xs text-slate-500">
                                                <span title="Biriktirilgan auditlar"><?php echo $u['audit_count']; ?> audit</span> ·
