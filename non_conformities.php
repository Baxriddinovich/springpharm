...
// в­ђ CAPA statuslari uchun statistika
...
// в­ђ Auditor o'ziga tegishli auditlarni ko'radi
...
// в­ђ URL builder funksiyasi (filterlarni saqlab qoladi)
...
<body class="min-h-screen text-slate-100">
    ...
    <!-- Mobile Header -->
<?php $activePage = "non_conformities"; include "inc/sidebar.php"; ?>
        ...
        <main class="flex-1 lg:ml-64 w-full">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-sm">
                            ...
                            <?php if ($ncStatusCounts['overdue'] > 0): ?>
                                <span class="text-red-400 font-medium"> В· <span class="underline"><?php echo $ncStatusCounts['overdue']; ?> ta muddati o'tgan</span></span>
                            <?php endif; ?>
                        </p>
                    </div>
            ...
            <div class="p-4 lg:p-8">
                ...
                <!-- в­ђ Status Tabs (Mobile-friendly) -->
                <div class="flex flex-wrap gap-2 mb-6 lg:hidden">
                    ...
                    <button onclick="applyStatusFilter('overdue')" data-status="overdue" class="filter-btn px-3 py-2 rounded-xl text-sm font-medium text-red-400 border-red-500/30">
                        Muddati o'tgan (<?php echo $ncStatusCounts['overdue']; ?> вљ пёЏ
                    </button>
                    <?php endif; ?>
                </div>
    ...
    <script>
        ...
        // в­ђ CAPA progress animatsiyasi
