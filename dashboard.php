...
<body class="min-h-screen text-slate-100">
    ...
    <!-- Mobile Menu Button -->
    <div
        class="lg:hidden fixed top-0 left-0 right-0 z-40 bg-slate-900/95 backdrop-blur-xl border-b border-slate-700/50 px-4 py-3 flex items-center justify-between">
        ...
        <button onclick="toggleSidebar()" id="menuBtn"
    ...
    <div class="flex min-h-screen pt-14 lg:pt-0">
            ...
            <div class="p-6 h-full flex flex-col">
                ...
                <nav class="space-y-1 flex-1 overflow-y-auto">
                    ...
                    <!-- <a href="non_conformities.php"
                        ...
                        Nomuvofiqliklar
                        <?php if ($stats['total_nc'] > 0): ?>
                            <span
                                class="ml-auto bg-red-500/20 text-red-400 text-xs px-2 py-0.5 rounded-full"><?php echo $stats['total_nc']; ?></span>
                        <?php endif; ?>
                    </a> -->
        ...
        <main class="flex-1 lg:ml-64 w-full">
            <header
                class="hidden lg:flex sticky top-0 z-20 bg-slate-900/80 backdrop-blur-xl border-b border-slate-700/50 px-8 py-4 items-center justify-between">
                <div>
                ...
                <div class="flex items-center gap-4">
                    <?php if ($pendingCapa > 0): ?>
                        <a href="non_conformities.php?filter=overdue"
                            class="flex items-center gap-2 bg-red-500/10 border border-red-500/30 text-red-400 px-4 py-2.5 rounded-xl font-medium transition-all hover:bg-red-500/20 pulse-danger">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="audits.php?action=new"
                        class="flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-white px-5 py-2.5 rounded-xl font-medium transition-all shadow-lg shadow-cyan-500/20">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="lg:hidden flex gap-2 p-4 overflow-x-auto">
                <?php if ($pendingCapa > 0): ?>
                    <a href="non_conformities.php?filter=overdue"
                        class="flex-shrink-0 flex items-center gap-2 bg-red-500/10 border border-red-500/30 text-red-400 px-4 py-2 rounded-xl text-sm">
                ...
                <?php endif; ?>
                <a href="audits.php?action=new"
                    class="flex-shrink-0 flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 rounded-xl text-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                    </svg>
                    Yangi Audit
            ...
            <div class="p-4 lg:p-8">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8">
                    <div class="stat-card rounded-2xl p-5 animate-in delay-1">
                        ...
                        <div class="text-3xl font-bold text-white mb-1"
                            data-count="<?php echo $stats['total_audits']; ?>">0</div>
                    ...
                    <div class="stat-card rounded-2xl p-5 animate-in delay-2">
                        ...
                        <div class="text-3xl font-bold text-white mb-1"
                            data-count="<?php echo $stats['active_audits']; ?>">0</div>
                    ...
                    <div class="stat-card rounded-2xl p-5 animate-in delay-3">
                        ...
                        <div class="text-3xl font-bold text-white mb-1"
                            data-count="<?php echo $stats['completed_audits']; ?>">0</div>
                    ...
                    <div class="stat-card rounded-2xl p-5 animate-in delay-4">
                        ...
                        <div class="text-3xl font-bold text-white mb-1" data-count="<?php echo $stats['total_nc']; ?>">0
                        </div>
                ...
                <div class="grid lg:grid-cols-3 gap-6 mb-8">
                    <!-- NC by Severity Chart (TO'G'RILANGAN) -->
                                ...
                                <svg class="progress-ring w-40 h-40" viewBox="0 0 120 120" id="donutChart">
                                    ...
                                    ?>
                                        <circle cx="60" cy="60" r="50" fill="none" stroke="<?php echo $colors[$i]; ?>"
                                            ...
                                            data-offset="<?php echo $offset ?? 0; ?>" class="progress-ring-circle"
                                            stroke-linecap="round" />
                                    <?php
                                        $offset = ($offset ?? 0) + $dashLength;
                                    endfor;
                                    ?>
                                </svg>
                                <div class="absolute inset-0 flex items-center justify-center">
                                    <div class="text-center">
                                        <div class="text-3xl font-bold text-white"
                                            data-count="<?php echo $stats['total_nc']; ?>">0</div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="w-3 h-3 rounded-full"
                                            style="background: <?php echo $nc['color_code']; ?>"></div>
                    ...
                    <div class="stat-card rounded-2xl p-6 animate-in delay-4">
                                ...
                                ?>
                                    <div class="flex-1 flex flex-col items-center gap-2">
                                        ...
                                        <div class="w-full bg-slate-800 rounded-t relative" style="height: 100px;">
                                            <div class="bar-chart-bar absolute bottom-0 left-0 right-0 bg-gradient-to-t from-cyan-500 to-cyan-400"
                                                data-height="<?php echo $heightPercent; ?>" style="height: 0%;">
                                            </div>
                                        </div>
                        ...
                        <div class="mt-4 pt-4 border-t border-slate-700/50 flex items-center justify-between text-sm">
                            ...
                            <span class="text-cyan-400">
                                O'rtacha: <?php
                                            $avg = !empty($monthlyStats) ? round(array_sum(array_column($monthlyStats, 'count')) / count($monthlyStats), 1) : 0;
                                            echo $avg;
                                            ?> / oy
                            </span>
                        </div>
                    ...
                    <div class="stat-card rounded-2xl p-6 animate-in delay-5">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="logs.php" class="text-cyan-400 hover:text-cyan-300 text-sm">Barchasi →</a>
                        </div>

                        <div class="space-y-4 max-h-[280px] overflow-y-auto pr-2">
                            <?php if (empty($recentActivity)): ?>
                                <div class="text-center text-slate-600 py-8">
                                    Hali faoliyatlar yo'q
                                </div>
                            <?php else: ?>
                                <?php foreach ($recentActivity as $activity):

                                    $dotColor =
                                        (strpos($activity['action_text'], 'yaratildi') !== false)
                                        ? 'border-cyan-400 bg-cyan-400/20'
                                        : (
                                            (strpos($activity['action_text'], 'tugallandi') !== false ||
                                                strpos($activity['action_text'], 'yopildi') !== false)
                        ...
                        <table class="w-full min-w-[600px]">
                            <thead>
                                <tr class="border-b border-slate-700/50">
                                    <th
                                        class="text-left text-xs font-medium text-slate-500 uppercase tracking-wider pb-3">
                                        Kod</th>
                                    <th
                                        class="text-left text-xs font-medium text-slate-500 uppercase tracking-wider pb-3">
                                        Korxona</th>
                                    ...
                                    <th
                                        ...
                                        Holat</th>
                                    <th
                                        class="text-right text-xs font-medium text-slate-500 uppercase tracking-wider pb-3">
                                        Progress</th>
                                    <th
                                        class="text-right text-xs font-medium text-slate-500 uppercase tracking-wider pb-3">
                                        Sana</th>
                                ...
                                <?php if (empty($recentAudits)): ?>
                                    <tr>
                                        <td colspan="6" class="py-12 text-center">
                                            ...
                                            <a href="audits.php?action=new"
                                                class="text-cyan-400 hover:text-cyan-300 text-sm mt-2 inline-block">Birinchi
                                                auditingizni yarating →</a>
                                        </td>
                                    </tr>
                                <?php else: ?>
                                    <?php foreach ($recentAudits as $audit):
                                        ...
                                        $progressColor = $audit['progress_percent'] >= 100 ? 'bg-emerald-500' : ($audit['progress_percent'] >= 50 ? 'bg-cyan-500' : 'bg-amber-500');
                                    ?>
                                        <tr class="hover:bg-slate-800/30 transition-colors cursor-pointer"
                                            onclick="window.location='audits.php?action=view&id=<?php echo $audit['id']; ?>'">
                                            <td class="py-4 font-mono text-cyan-400 text-sm">
                                                <?php echo htmlspecialchars($audit['audit_code']); ?>
                                            </td>
                                            <td class="py-4">
                                            ...
                                            <td class="py-4">
                                                <div class="text-slate-400 text-sm">
                                                    <?php echo htmlspecialchars($audit['creator_name']); ?>
                                                </div>
                                            </td>
                                            <td class="py-4">
                                                <span
                                                    class="badge <?php echo $statusClasses[$audit['status']] ?? 'badge-info'; ?>">
                                            ...
                                            <td class="py-4 text-right">
                                                <div class="flex items-center justify-end gap-2">
                                                    <div class="w-16 h-1.5 bg-slate-700 rounded-full overflow-hidden">
                                                        <div class="h-full <?php echo $progressColor; ?> rounded-full transition-all duration-1000"
                                                            style="width: 0%"
                                                            data-width="<?php echo $audit['progress_percent']; ?>%"></div>
                                                    </div>
                                                    <span
                                                        class="text-sm text-slate-400 w-10 text-right font-mono"><?php echo number_format($audit['progress_percent'], 0); ?>%</span>
                                                </div>
                                            </td>
                                            <td class="py-4 text-right text-slate-500 text-sm">
                                                <?php echo date('d.m.Y', strtotime($audit['created_at'])); ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                ...
                <!-- Quick Actions & NC Summary -->
                <div class="grid lg:grid-cols-2 gap-6">
                    <!-- Quick Actions -->
                    <div class="stat-card rounded-2xl p-6 animate-in delay-5">
                        <h3 class="text-lg font-semibold text-white mb-6">Tezkor amallar</h3>
                        <div class="grid grid-cols-2 gap-4">
                            <a href="audits.php?action=new"
                                class="group flex flex-col items-center gap-3 p-4 rounded-xl bg-slate-800/50 hover:bg-cyan-500/10 border border-slate-700/50 hover:border-cyan-500/30 transition-all">
                                <div
                                    class="w-12 h-12 rounded-xl bg-cyan-500/20 group-hover:bg-cyan-500/30 flex items-center justify-center transition-colors">
                                    <svg class="w-6 h-6 text-cyan-400" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M12 4v16m8-8H4" />
                                ...
                                <span class="text-sm text-slate-400 group-hover:text-white transition-colors">Yangi
                                    Audit</span>
                            </a>

                            <a href="non_conformities.php?action=new"
                                class="group flex flex-col items-center gap-3 p-4 rounded-xl bg-slate-800/50 hover:bg-red-500/10 border border-slate-700/50 hover:border-red-500/30 transition-all">
                                <div
                                    class="w-12 h-12 rounded-xl bg-red-500/20 group-hover:bg-red-500/30 flex items-center justify-center transition-colors">
                                ...
                                <span class="text-sm text-slate-400 group-hover:text-white transition-colors">NC
                                    Qo'shish</span>
                            </a>

                            <a href="reports.php"
                                class="group flex flex-col items-center gap-3 p-4 rounded-xl bg-slate-800/50 hover:bg-blue-500/10 border border-slate-700/50 hover:border-blue-500/30 transition-all">
                                <div
                                    class="w-12 h-12 rounded-xl bg-blue-500/20 group-hover:bg-blue-500/30 flex items-center justify-center transition-colors">
                                ...
                                <span
                                    class="text-sm text-slate-400 group-hover:text-white transition-colors">Hisobotlar</span>
                            </a>

                            <a href="checklists.php"
                                class="group flex flex-col items-center gap-3 p-4 rounded-xl bg-slate-800/50 hover:bg-purple-500/10 border border-slate-700/50 hover:border-purple-500/30 transition-all">
                                <div
                                    class="w-12 h-12 rounded-xl bg-purple-500/20 group-hover:bg-purple-500/30 flex items-center justify-center transition-colors">
                                ...
                                <span
                                    class="text-sm text-slate-400 group-hover:text-white transition-colors">Checklistlar</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <!-- 🆕 NC Summary Cards -->
                    <div class="stat-card rounded-2xl p-6 animate-in delay-5">
                        <h3 class="text-lg font-semibold text-white mb-6">Nomuvofiqliklar xulosasi</h3>
                        <div class="space-y-4">
                            <!-- Critical -->
                            <div class="flex items-center gap-4 p-3 rounded-xl bg-red-500/5 border border-red-500/20">
                                <div
                                    class="w-10 h-10 rounded-lg bg-red-500/20 flex items-center justify-center flex-shrink-0">
                                    <span
                                        class="text-red-400 font-bold text-lg"><?php echo $stats['critical_nc']; ?></span>
                                </div>
                                <div class="flex-1">
                                    <div class="text-white text-sm font-medium">Kritik</div>
                                    <div class="text-xs text-slate-500">Jiddiy xavf, darhol tuzatish talab etiladi</div>
                                </div>
                            ...
                            <!-- Major -->
                            <div
                                class="flex items-center gap-4 p-3 rounded-xl bg-amber-500/5 border border-amber-500/20">
                                <div
                                    class="w-10 h-10 rounded-lg bg-amber-500/20 flex items-center justify-center flex-shrink-0">
                                    <span
                                        class="text-amber-400 font-bold text-lg"><?php echo $stats['major_nc']; ?></span>
                                </div>
                                <div class="flex-1">
                                    <div class="text-white text-sm font-medium">Asosiy</div>
                                    <div class="text-xs text-slate-500">Muhim kamchilik, reja bo'yicha tuzatiladi</div>
                                </div>
                            ...
                            <!-- Minor -->
                            <div
                                class="flex items-center gap-4 p-3 rounded-xl bg-emerald-500/5 border border-emerald-500/20">
                                <div
                                    class="w-10 h-10 rounded-lg bg-emerald-500/20 flex items-center justify-center flex-shrink-0">
                                    <span
                                        class="text-emerald-400 font-bold text-lg"><?php echo $stats['minor_nc']; ?></span>
                                </div>
                                <div class="flex-1">
                                    <div class="text-white text-sm font-medium">Kichik</div>
                                    <div class="text-xs text-slate-500">Norasmiy kamchilik, takliflar sifatida</div>
                                </div>
                            ...
                            <?php if ($pendingCapa > 0): ?>
                                <div
                                    class="flex items-center gap-4 p-3 rounded-xl bg-red-500/10 border border-red-500/30 pulse-danger">
                                    <div
                                        class="w-10 h-10 rounded-lg bg-red-500/30 flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex-1">
                                        <div class="text-red-400 text-sm font-medium"><?php echo $pendingCapa; ?> ta muddati
                                            o'tgan CAPA</div>
                                        <div class="text-xs text-slate-500">Darhol e'tibor berish talab etiladi</div>
                                    </div>
                                    <a href="non_conformities.php?filter=overdue"
                                        class="text-red-400 hover:text-red-300 text-sm">Ko'rish →</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <footer class="px-8 py-6 border-t border-slate-800 mt-8">
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-600">
                    <span>GMP Audit Tizimi v2.0 © <?php echo date('Y'); ?></span>
    ...
    <script>
        ...
        // 🆕 Donut chart animation (TO'G'RILANGAN)
        function animateDonutChart() {
            ...
            circles.forEach((circle, index) => {
                ...
                setTimeout(() => {
                    circle.style.strokeDasharray = targetDasharray;
                }, 200 + (index * 150));
            });
        }
        ...
        document.addEventListener('keydown', (e) => {
            if (e.ctrlKey && e.key === 'n') {
                e.preventDefault();
                window.location.href = 'audits.php?action=new';
            }
        });
    </script>
</body>
