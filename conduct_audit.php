...
<body class="min-h-screen text-slate-100">
    ...
    <header class="sticky top-0 z-30 bg-slate-900/95 backdrop-blur-xl border-b border-slate-700/50 px-6 py-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="audits.php" class="text-slate-400 hover:text-white">
            ...
            <div class="flex items-center gap-4 text-sm">
                ...
                <div class="hidden md:flex items-center gap-2">
                    <div class="w-32 h-2 bg-slate-700 rounded-full">
                        <div id="progressBar" class="h-full bg-cyan-500 rounded-full transition-all" style="width: <?php echo $progress; ?>%"></div>
                    </div>
    ...
    <script>
        ...
        function autoCreateNC(qId) {
            ...
            fetch('conduct_audit.php?id=' + auditId, {
                    method: 'POST',
                    body: formData
                })
                .then(res => res.json())
        ...
        function renderNCBadge(qId, code, ncId, severityId, desc) {
            ...
            if (severityId == 2) {
                badgeClass = 'nc-badge-major';
                sevName = 'Jiddiy';
                colorClass = 'text-amber-400';
            }
            if (severityId == 3) {
                badgeClass = 'nc-badge-critical';
                sevName = 'O\'ta jiddiy';
        ...
        function uploadImage(qId) {
            const input = document.getElementById('image-' + qId);
